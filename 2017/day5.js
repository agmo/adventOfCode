function countStepsToEscapeMazePart1(jumpOffsetsArr) {
    let currentIndex = 0;
    let lastIndex = 0;
    let steps = 0;
    const length = jumpOffsetsArr.length;

    do {
        currentIndex += jumpOffsetsArr[currentIndex];
        jumpOffsetsArr[lastIndex] = jumpOffsetsArr[lastIndex] += 1;
        steps++;
...
function countStepsToEscapeMazePart2(jumpOffsetsArr) {
    let currentIndex = 0;
    let lastIndex = 0;
    let steps = 0;
    const length = jumpOffsetsArr.length;
    ...
    do {
        currentIndex += jumpOffsetsArr[currentIndex];
        jumpOffsetsArr[lastIndex] =
            jumpOffsetsArr[lastIndex] >= 3 ? jumpOffsetsArr[lastIndex] -= 1 : jumpOffsetsArr[lastIndex] += 1;
        steps++;
        lastIndex = currentIndex;
    } while (currentIndex >= 0 && currentIndex < length);
